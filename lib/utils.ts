...
export const HIGHLIGHTED_SURFACE_SHADOW = highlightedSurfaceShadow("#004cff");

export function highlightedSurfaceShadow(accentColor: string): string {
  return `inset 0 0 0 1px #ffffff, 0 0 0 1px color-mix(in srgb, ${accentColor} 28%, transparent), 0 2px 6px rgba(16, 24, 40, 0.08), ${ELEVATION_SHADOW}`;
}
